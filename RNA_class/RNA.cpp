...
int RNA::InitializeSinglestranded()
{
//    cerr << "Initialize Singlestranded\n";
    return ct->initialize_singlestranded();
//    cerr << "Initialize Singlestranded Ends\n";
}

int RNA::SetSinglestranded(vector<double>* value)
{
//    cerr << "Set Singlestranded\n";
    return ct->set_singlestranded(value);
//    cerr << "Set Singlestranded Ends\n";
}
