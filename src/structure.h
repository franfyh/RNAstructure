...
//>>>>>>> ../../RNAstructure-object/src/structure.h
		...
		bool SHAPEFileRead;
                vector<vector<double> > singlestranded_constant;

//                void allocate_singlestranded_info();
                double singlestrandedconstant(int i);
                double singlestrandedconstant(int i, int j);
                int initialize_singlestranded();
                int set_singlestranded(vector<double>* value); 
	//private:
