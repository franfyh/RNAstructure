...
Multifind: Multifind/Multifind_Interface.o RNA_class/Multifind_object.o RNA_class/Multilign_object-Multifind.o ${CMD_LINE_PARSER} ${DYNALIGN_SERIAL_FILES} ${ROOTPATH}/libsvm-3.18/svm.o 
	cd ${ROOTPATH}/libsvm-3.18;make svm.o;
	${LINK_IN_EXE_DIR} Multifind/Multifind_Interface.o  RNA_class/Multifind_object.o RNA_class/Multilign_object-Multifind.o ${CMD_LINE_PARSER} ${DYNALIGN_SERIAL_FILES} ${ROOTPATH}/libsvm-3.18/svm.o 
...
Multifind-smp: Multifind/Multifind_Interface-smp.o RNA_class/Multifind_object.o RNA_class/Multilign_object-Multifind.o ${CMD_LINE_PARSER} ${DYNALIGN_SMP_FILES} ${INCLUDESVM}/svm.o 
	cd ${ROOTPATH}/libsvm-3.18;make svm.o;
	${LINK_IN_EXE_DIR} Multifind/Multifind_Interface-smp.o  RNA_class/Multifind_object.o RNA_class/Multilign_object-Multifind.o ${CMD_LINE_PARSER} ${DYNALIGN_SMP_FILES} ${ROOTPATH}/libsvm-3.18/svm.o -lpthread
...
conserved_training: ${ROOTPATH}/conserved_training/conserved_training.cpp ${ROOTPATH}/conserved_training/conserved_training.h ${CONFIG_FILE_PARSER} ${CMD_LINE_PARSER} ${RNA_FILES} ${PHMM_FILES}
	${LINK_IN_EXE_DIR} -I${ROOTPATH} ${ROOTPATH}/dlib/all/source.cpp -lpthread -lX11 ${ROOTPATH}/conserved_training/conserved_training.cpp ${CONFIG_FILE_PARSER} ${CMD_LINE_PARSER} ${RNA_FILES} ${PHMM_FILES} 

conserved_training_smp: ${ROOTPATH}/conserved_training/conserved_training.cpp ${ROOTPATH}/conserved_training/conserved_training.h ${CONFIG_FILE_PARSER} ${CMD_LINE_PARSER} ${RNA_FILES_SMP} ${PHMM_FILES}
	${LINK_IN_EXE_DIR} -fopenmp -I${ROOTPATH} ${ROOTPATH}/dlib/all/source.cpp -lpthread -lX11 ${ROOTPATH}/conserved_training/conserved_training.cpp ${CONFIG_FILE_PARSER} ${CMD_LINE_PARSER} ${RNA_FILES_SMP} ${PHMM_FILES}
